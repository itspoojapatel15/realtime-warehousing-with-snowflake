...
I've developed this repository to illustrate implementing data streaming and analytics using Snowflake, particularly focusing on workflows with Snowflake's new UI, Snowsight, as comprehensive resources can be scarce.
* * *
### What's Snowflake?
...
This project is maintained by Pooja Patel, a Data Science Graduate with a strong background in statistical analysis, predictive modeling, and data visualization. Pooja is proficient in Python, R, SQL, Tableau, and Power BI, with hands-on experience in analyzing large datasets, automating workflows, and improving decision-making. 
For questions or collaborations, feel free to connect:
- **Email:** patel.pooja81599@gmail.com
- **LinkedIn:** Pooja Patel
- **GitHub:** PoojaPatel